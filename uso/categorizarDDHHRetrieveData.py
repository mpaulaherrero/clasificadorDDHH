...
categoriesExcluded = ["Entretenimiento", "Arte", "EE UU", "Politica", "entretenimiento", "internacional", "el-universal", "politica", "Fútbol", "Beisbol", "doblevia", "deportes", "Deportes", "Cine", "BBC Mundo", "Música", "Ciencia y Tecnología", "estilo-de-vida", "Europa", "España, Mundo", "Motores", "Bienestar"]
